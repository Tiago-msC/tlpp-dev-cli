...
/*/
//-------------------------------------------------------------------
Class CTBATestCase FROM FWDefaultTestCase
	DATA oHelper

	METHOD  SetUpClass()
	METHOD  CTBATestCase() Constructor
...
/*/
//-----------------------------------------------------------------
METHOD CTBATestCase() Class CTBATestCase
	...
	// Self:AddTestMethod("teste_004",,"POST - Gravar alteracao ctba")
	//EndIf
Return
...
/*/
//-----------------------------------------------------------------
METHOD SetUpClass() CLASS CTBATestCase
...
/*/
//-------------------------------------------------------------------
METHOD teste_001() CLASS CTBATestCase
	Local aHeader   := {}
	Local cBody     := ""
	Local cRet      := ""
	Local cJsonRet  := ""
	...
	cBody := '{"teste": "Teste"}'
		...
		Else        
				...
				If cJsonRet == "{}"
						oHelper:UTPutError("Falha ao gravar ctba")
				EndIf
...
/*/
//-------------------------------------------------------------------
// METHOD teste_002() CLASS CTBATestCase
//     Local aHeader   := {}
//     Local cBody     := ""
//     Local cRet      := ""
//     Local cJsonRet  := ""
...
// /*/
// //-------------------------------------------------------------------
// METHOD teste_003() CLASS CTBATestCase
//     Local aHeader   := {}
//     Local cBody     := ""
//     Local cRet      := ""
//     Local cJsonRet  := ""
...
// /*/
// //-------------------------------------------------------------------
// METHOD teste_004() CLASS CTBATestCase
//     Local aHeader   := {}
//     Local cBody     := ""
//     Local cRet      := ""
//     Local cJsonRet  := ""
